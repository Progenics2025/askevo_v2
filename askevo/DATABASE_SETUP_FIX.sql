-- ============================================================================
-- PROGENICS AI - MySQL Database Setup (Fixed Version)
-- Run this as root or admin user first
-- ============================================================================
...
-- Step 2: Grant all privileges on all databases to the user
...
-- ============================================================================
-- Now run the rest of the database setup
-- ============================================================================
...
SELECT user, host, Super_priv, Create_priv, Drop_priv FROM mysql.user WHERE user = 'remote_user';
